...
public class ReflectCacheTest {
  ...
  public void tesAppClassLoader() throws ExecutionException {
    ...
    Assert.assertEquals(
        ClassLoaderUtils.getCurrentClassLoader(), ReflectCache.getAppClassLoader("ccc"));
  ...
  public void tesServiceClassLoader() throws ExecutionException {
    ...
    Assert.assertEquals(
        ClassLoaderUtils.getCurrentClassLoader(), ReflectCache.getServiceClassLoader("ccc"));
    ReflectCache.cleanAll();
  }
}

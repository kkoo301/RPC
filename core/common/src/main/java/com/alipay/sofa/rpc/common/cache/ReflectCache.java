...
public final class ReflectCache {
  ...
  /** 应用对应的ClassLoader */
  private static final Cache<String, ClassLoader> APPNAME_CLASSLOAD_MAP =
      CacheBuilder.newBuilder().build();

  /** 服务对应的ClassLoader */
  private static final Cache<String, ClassLoader> SERVICE_CLASSLOAD_MAP =
      CacheBuilder.newBuilder().build();
  ...
  private static final Cache<String, Map<ClassLoader, Class>> CLASS_CACHE =
      CacheBuilder.newBuilder().build();

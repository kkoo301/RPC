...
public class LoggerFactory {
    ...
    public static Logger getLogger(String name) {
        try {
            Object instance = ClassUtils.forName(implClass, Logger.class.getClassLoader()).getConstructor(String.class).newInstance(name);
    ...
    public static Logger getLogger(Class clazz) {
        try {
            Object instance = ClassUtils.forName(implClass, Logger.class.getClassLoader()).getConstructor(Class.class).newInstance(clazz);
            if (instance instanceof Logger) {
                return (Logger) instance;
            } else {
                throw new SofaRpcRuntimeException(implClass + " is not type of " + Logger.class);

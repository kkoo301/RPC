...
public class RpcOptions {
  ...
  public static final String CONSUMER_REPEATED_REFERENCE_LIMIT =
      "consumer.repeated.reference.limit";
  /**
   * 初始化连接时建立连接的百分比
   *
   * @since 5.5.0
  ...
  /**
   * 客户端IO 比例：用户在代码中使用到了Runnable和ScheduledFutureTask，请合理设置ioRatio的比例， 通过NioEventLoop的setIoRatio(int
   * ioRatio)方法可以设置该值，默认值为50，即I/O操作和用户自定义任务的执行时间比为1：1
   */
  ...
  public static final String TRANSPORT_SERVER_PROTOCOL_ADAPTIVE =
      "transport.server.protocol.adaptive";
  /** 是否跨接口的长连接复用 */
  ...
  public static final String TRANSPORT_CLIENT_H2C_USE_PRIOR_KNOWLEDGE =
      "transport.client.h2c.usePriorKnowledge";
  /** 是否开启压缩 */
